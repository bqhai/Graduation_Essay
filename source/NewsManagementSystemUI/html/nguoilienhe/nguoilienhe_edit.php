...
<head>
    ...
    <title>VCCI - Chỉnh sửa Người Liên Hệ</title>
                            ...
                            <div class="row" style="padding-bottom:8px">
                                <div class="col-md-4">
                                    <h2><i class="icon-arrow-left52 position-left font-size-100"></i> <span
                                            class="text-semibold" id="content">Sửa người liên hệ</span></h4>
                                </div>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody >
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select width: 50% class="bootstrap-select"
                                                                data-width="50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input style="width:50%" type="text" value="Huỳnh Văn Bê" class="form-control"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select class="bootstrap-select" data-width="50%">
                                                                ...
                                                                <option value="2" selected="selected">Giám đốc</option>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <select class="bootstrap-select" data-width="50%">
                                                                ...
                                                                <option value="2" selected="selected">Tín dụng - Đầu tư
                                                                </option>
                                                            </select>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input style="width:50%" type="text" class="form-control" value="0123456789"
                                                                id="exampleInputEmail1" aria-describedby="emailHelp"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input style="width:50%" type="email" class="form-control"
                                                                value="duongtuyet173@gmail.com" id="exampleInputEmail1"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input style="width:50%" class="form-control" type="date" data-width="50%"
                                                                value="11/1092020">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select class="bootstrap-select" data-width="50%">
                                                                ...
                                                                <option value="2" selected="selected">MNCL Lê Thị Riêng
                                                                </option>
