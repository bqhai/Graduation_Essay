...
<head>
    ...
    <title>VCCI - Thông tin Lịch Sử Đóng Phí Hội Viên</title>
                        ...
                        <div class="page-title">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <h2><i class="icon-arrow-left52 position-left font-size-100"></i> <span class="text-semibold" id="content"></span>Lịch Sử Đóng Phí Hội Viên</h4>
                                        </div>
                                    ...
                                    <table class="table table-togglable table-hover table-bordered table-striped">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th class="text-left" style="width:20%" data-toggle="true">Gói phí</th>

                                                        <th class="text-left" style="width:80%" data-toggle="true">Gói VIP 1</th>

                                                    </tr>
                                                    <tr>
                                                        <th class="text-left" style="width:20%" data-toggle="true">Phí</th>

                                                        <th class="text-left" style="width:80%" data-toggle="true">3.000.000</th>

                                                    </tr>
                                                    <tr>
                                                        <th class="text-left" style="width:20%" data-toggle="true">Ngày đóng phí</th>

                                                        <th class="text-left" style="width:80%" data-toggle="true">15/05/2020 08:00</th>

                                                    </tr>
                                                    <tr>
                                                        <th class="text-left" style="width:20%" data-toggle="true">Hóa đơn</th>

                                                        <th class="text-left" style="width:80%" data-toggle="true">HD 001</th>
