            ...
            <div class="modal-body">
                ...
                <div class='form-group'>
                    ...
                    <div class='checkbox inline'><label><input type='checkbox' checked name='columns[]'
                                value='id'>ID</label></div>
                    <div class='checkbox inline'><label><input type='checkbox' checked name='columns[]'
                                value='tenungvien'>Tên ứng viên</label></div>
                    <div class='checkbox inline'><label><input type='checkbox' checked name='columns[]'
                                value='tuoi'>Tuổi</label></div>
                    <div class='checkbox inline'><label><input type='checkbox' checked name='columns[]'
                                value='sodienthoai'>Điện thoại</label></div>
                    <div class='checkbox inline'><label><input type='checkbox' checked name='columns[]'
                                value='diachi'>Địa chỉ</label></div>
                </div>
